...
public class VeicoloBean {
	...
	public VeicoloBean(String targa, String marca, String modello,
			String data_immatricolazione, String soglia_email, String soglia_sms, String email_utente, boolean valid) {
		super();
		this.targa = targa;
		this.marca = marca;
	...
	public VeicoloBean() {
		new VeicoloBean(targa, marca, modello, data_immatricolazione, soglia_sms, email_utente, email_utente, valid);
	}
