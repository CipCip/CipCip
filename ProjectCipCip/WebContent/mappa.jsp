...
self.setInterval("startRender()",500);
  ...
  <body onload="javascript:initialize();">
   <div id="map_canvas" style="height:70%;top:30px;border:1px solid black;"></div><br/><br/>
<center><input type="button" value="Start Simulation" onclick="javascript:dummyStart();"></input><br/><br>
Code Explanation/Article: <a href="http://mypersonalsoft.blogspot.com/2012/02/simulating-moving-targets-in-google.html">http://mypersonalsoft.blogspot.com/2012/02/simulating-moving-targets-in-google.html</a>
<br/><font size="1">&copy; HobbyCoders.com</font></center>
  </body>
</html>